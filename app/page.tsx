            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 border border-green-100 mb-6">
                <span className="relative flex h-2 w-2">
                  ...
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-grenn-500"></span>
                </span>
                <span className="text-xs text-green-700 font-medium">Nouvelle version v2.0</span>
              </div>
